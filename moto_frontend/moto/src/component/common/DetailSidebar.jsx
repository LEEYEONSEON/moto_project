...
export default function DetailSidebar(props) {
    ...
    const { loginMember, setIsLogined, setAccessToken, setRefreshToken } = useUserStore();
    ...
    return (
        <div className="side-menu">
            ...
            <div className="menu-item" style={{ paddingBottom: "40px" }}>
                <Link to={"/user/me/portfolio?filter = TYPE"} style={{fontSize:"25px", color:"white"}}>
                   포트폴리오
                </Link>
            </div>
